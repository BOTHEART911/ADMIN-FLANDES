/* ============================================================
   ADMIN-FLANDES · SERVICE WORKER DEL CACHÉ
   Fase 10 (el mismo de las otras apps, con el armazón de esta)
...
var VERSION = 'admin-v' + APP_VERSION;
/* 10.1: solo se borran las cachés de ESTA app (las siete comparten origen) */
var PREFIJO_CACHE = 'admin-v20';   /* '-v20': la vieja de producción usa 'contratista-v3' y no es de esta */
